...
const resetAdmins = async () => {
    try {
        ...
        console.log(`🗑️  Deleted ${deletedAdminDetails.deletedCount} admin detail record(s)`);
...
const createAdditionalAdmin = async (username, email, password, name, phone) => {
    try {
    ...
    try {
        if (command === 'reset') {
            ...
            if (!username || !email || !password) {
                console.log('❌ Usage: node resetAdmin.js create <username> <email> <password> [name] [phone]');
                console.log('📝 Example: node resetAdmin.js create john john@admin.com password123 "John Doe" "1234567890"');
                process.exit(1);
            }
            ...
            console.log('  Create new admin:     node resetAdmin.js create <username> <email> <password> [name] [phone]');
            console.log('\n📝 Examples:');
            console.log('  node resetAdmin.js reset');
            console.log('  node resetAdmin.js create john john@admin.com password123 "John Doe" "1234567890"');
        }
    } catch (error) {
